...
var extensions = {
  ...
  'image': [['jpg', 'jpeg', 'gif', 'tiff', 'tif', 'bmp', 'png', 'tga', 'webp'], 'Image', 'mdi-file-image'],
...
function isPreviewable(name) {
  return previewable.indexOf(getExt(name)) > -1;
}
function getPreviewType(name) {
  var i = previewable.indexOf(getExt(name))
  if (i > -1) {
